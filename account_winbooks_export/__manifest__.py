...

{
    ...
    'author': "Ludovic Lelarge,LIBERTYSOFT,HORIYASOFT",
    'category': 'Accounting',
    'description': """

    Add a wizard that allow you to export data to Winbooks- Ajouter un wizard vous permettant d'exporter des données vers Winbooks
